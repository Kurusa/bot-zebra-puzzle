...
{
    public static function createDifficultyKeyboard(Puzzle $puzzle): InlineKeyboardMarkup
    {
    ...
    public static function createSolvingKeyboard(Puzzle $puzzle): InlineKeyboardMarkup
    {
        return new InlineKeyboardMarkup([
            [
                [
                    'text' => __('texts.puzzle_solving'),
                    'callback_data' => json_encode([
                        'p' => $puzzle->id,
                        'a' => CallbackAction::START_SOLVING->value,
                    ]),
